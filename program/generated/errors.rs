...
impl PrintProgramError for NftError {
    ...
    {
        match self {
            NftError::InvalidInstruction => msg!("Error: Invalid instruction"),
            NftError::InvalidSignerPermission => msg!("Error: The account is_signer value is not the expected one"),
            NftError::NotExpectedAddress => {
                msg!("Error: Not the expected account address")
            }
            NftError::WrongAccountOwner => msg!("Error: Wrong account owner"),
            NftError::InvalidAccountLen => msg!("Error: Invalid account length"),
            NftError::ExecutableAccountExpected => msg!("Error: Executable account expected"),
